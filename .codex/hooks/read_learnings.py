#!/usr/bin/env python3
"""Print learning context for agent session-start hooks."""
...
def first_existing_directory(project_root: Path) -> Path:
    candidates = [
        project_root / ".codex" / "rules" / "learnings",
        project_root / ".learnings",
    ]
...
def main() -> int:
    ...
    learnings_dir = first_existing_directory(project_root)
