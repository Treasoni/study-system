...
本技能负责意图澄清，完成后调用 workflow-orchestrator 生成命名 workflow state file。完整编排流程见 `.codex/skills/workflow-orchestrator/SKILL.md`，阶段定义见 `.codex/workflows/learning-note-flow/workflow.md`。
