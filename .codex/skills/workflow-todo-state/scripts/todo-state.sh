...
usage() {
  cat <<'USAGE'
Usage:
  .codex/scripts/todo-state.sh <todo.md> start P1
  .codex/scripts/todo-state.sh <todo.md> complete P1
  .codex/scripts/todo-state.sh <todo.md> skip P3 "reason"
  .codex/scripts/todo-state.sh <todo.md> block P2 "reason"
