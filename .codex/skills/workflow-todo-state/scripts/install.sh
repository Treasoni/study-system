...
- Use `.codex/rules/workflow-routing.md` to decide which workflow applies.
...
Next:
  ...
  3. Test: .codex/scripts/todo-state.sh workspace/workflow-runs/{task}.workflow.md start P0
EOF
