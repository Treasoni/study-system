...
| --- | --- | --- | --- |
| `learning-note-flow` | 新主题学习笔记生产、资料收集、逐章写作、Obsidian 发布 | `.codex/workflows/learning-note-flow/workflow.md` | `workspace/workflow-runs/{topic}.workflow.md` |
| `legacy-note-import-flow` | 旧笔记批量导入、盘点、规范化、可选更新 | `.codex/workflows/legacy-note-import-flow/workflow.md` | `workspace/workflow-runs/import-{source}.workflow.md` |
| `batch-note-update-flow` | 多篇既有笔记批量更新、逐篇局部 patch | `.codex/workflows/batch-note-update-flow/workflow.md` | `workspace/workflow-runs/update-{scope}.workflow.md` |
