...
description: "Use this agent when the user has completed research material collection and wants to generate a learning notes outline for confirmation before writing chapters. This agent reads the collected research materials and intent file, then produces a structured outline with chapter metadata. Examples: <example>Context: The user has finished the deep research phase and now needs to organize the findings into a writing plan.\\nuser: \"素材收集完了，帮我生成大纲\"\\nassistant: \"我来使用 outline-generator agent，基于你的研究素材生成学习大纲。\"\\n<commentary>\\nThe user has completed research and wants to produce an outline. This triggers the outline-generator agent which reads the research output and generates a structured outline.\\n</commentary></example> <example>Context: After research collection, the user asks for an outline or learning path structure.\\nuser: \"根据收集的资料帮我整理一个大纲看看\"\\nassistant: \"我来启动 outline-generator agent，根据你收集的素材生成大纲。\"\\n<commentary>\\nThe user wants to organize collected materials into an outline. Use the outline-generator agent to read the research file and produce the outline.\\n</commentary></example> <example>Context: User explicitly requests outline generation after research phase.\\nuser: \"02_deep_research.md 准备好了，生成大纲吧\"\\nassistant: \"好的，我来用 outline-generator agent 生成大纲。\"\\n<commentary>\\nExplicit request for outline generation from research materials. Launch the outline-generator agent.\\n</commentary></example>"
tools: Edit, Write, Read, Glob, Bash, Grep
model: sonnet
color: red
---
