...
对每个收集到的文件进行四维度评分（1-5 分）：

| 维度 | 评分标准 |
|------|----------|
| **权威性 (authority)** | 5=官方文档, 4=知名技术博客, 3=社区优质回答, 2=普通博客, 1=匿名/不可信来源 |
| **时效性 (freshness)** | 5=近 6 个月, 4=近 1 年, 3=近 2 年, 2=近 3 年, 1=超过 3 年或无法判断 |
| **完整性 (completeness)** | 5=全面覆盖主题, 4=覆盖主要方面, 3=覆盖部分方面, 2=仅触及表面, 1=过于简略 |
| **可读性 (readability)** | 5=结构清晰、示例丰富, 4=结构良好, 3=可读但有改进空间, 2=结构混乱, 1=难以阅读 |
