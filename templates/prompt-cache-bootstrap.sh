...
install_observability() {
  ...
  install_asset "$SCRIPT_DIR/llm-usage-event.schema.json" "$observability_dir/llm-usage-event.schema.json"
  install_asset "$SCRIPT_DIR/prompt-cache-regression-cases.json" "$observability_dir/regression-cases.json"
}
