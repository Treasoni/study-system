...
# 阶段 1（探测式收集）：
.codebuddy/scripts/todo-state.sh "$WORKFLOW_STATE_FILE" start P1
# 阶段 2（深度收集）：
.codebuddy/scripts/todo-state.sh "$WORKFLOW_STATE_FILE" start P2
```
...
# 阶段 1 完成：
.codebuddy/scripts/todo-state.sh "$WORKFLOW_STATE_FILE" complete P1
# 阶段 2 完成：
.codebuddy/scripts/todo-state.sh "$WORKFLOW_STATE_FILE" complete P2
```
