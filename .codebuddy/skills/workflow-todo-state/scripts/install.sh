...
Options:
  ...
  --skills-dir DIR  Skill installation directory (default: <agent-dir>/skills; Codex profile: .codebuddy/skills).
...
load_profile() {
  ...
  case "$name" in
    codex)
      AGENT_DIR=".codex"; SKILLS_DIR=".codebuddy/skills"; RULES_DIR=".codebuddy/rules"; SCRIPTS_DIR=".codebuddy/scripts"; WORKFLOWS_DIR=".codebuddy/workflows"; ENTRY_FILE="CODEBUDDY.md"
      ;;
    claude)
      ...
      ;;
    generic)
      AGENT_DIR=".agent"; SKILLS_DIR=".agent/skills"; RULES_DIR=".agent/rules"; SCRIPTS_DIR=".agent/scripts"; WORKFLOWS_DIR=".agent/workflows"; ENTRY_FILE="CODEBUDDY.md"
      ;;
    *)
