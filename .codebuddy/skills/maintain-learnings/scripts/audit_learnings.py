...
def main() -> int:
    ...
    parser.add_argument("--skills-dir", default=".codebuddy/skills")
    parser.add_argument("--rules-file", default="CODEBUDDY.md")
    parser.add_argument("--hooks-path", default=".codebuddy/hooks")
