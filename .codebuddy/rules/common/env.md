...
1. **识别项目类型**：读取根目录清单和入口文件，例如 `package.json`、`pnpm-lock.yaml`、`pyproject.toml`、`requirements.txt`、`Cargo.toml`、`go.mod`、`Dockerfile`、`docker-compose.yml`、`README.md`、`CODEBUDDY.md`。
