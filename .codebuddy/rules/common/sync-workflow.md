...
- `.codex/platform/**`
- `.codebuddy/workflows/**`
- `CODEBUDDY.md` 中改变了工作流、skill 路由或规则路径

## Command

```bash
.codebuddy/scripts/sync-codex-to-claude.sh
```

同步后必须验证镜像没有漂移：

```bash
.codebuddy/scripts/sync-codex-to-claude.sh --check
```
